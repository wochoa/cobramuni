...
class CreateTramDependenciaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tram_dependencia', function (Blueprint $table) {
            ...
            $table->string('depe_nombre')->nullable();
            $table->string('depe_abreviado')->nullable();
            $table->string('depe_sigla')->nullable();
            $table->string('depe_representante')->nullable();
            $table->string('depe_cargo')->nullable();
            $table->string('depe_dni', 8)->nullable();
            $table->integer('depe_depende')->nullable();
            $table->string('depe_superior')->nullable();
            $table->integer('depe_tipo');
            $table->integer('depe_proyectado');
            $table->integer('depe_estado')->nullable();
            $table->string('depe_observaciones')->nullable();
            ...
            $table->string('depe_imagen_header')->nullable();
            $table->string('depe_imagen_footer')->nullable();
            $table->integer('depe_rrhh')->nullable();
            $table->string('depe_ciudad')->nullable();
